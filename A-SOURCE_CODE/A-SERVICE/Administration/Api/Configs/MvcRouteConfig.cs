...
namespace Administration.Configs
{
    public class MvcRouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            // website route
            //routes.MapRoute("IntroPatient", "intro/patient", new {controller = "Home", action = "Page"});
            //routes.MapRoute("Messages", "messages", new { controller = "Home", action = "Page" });
            //routes.MapRoute("IntroDoctor", "intro/doctor", new {controller = "Home", action = "Page"});
            //routes.MapRoute("Signin", "signin", new {controller = "Home", action = "Page"});
            //routes.MapRoute("Signup", "signup", new {controller = "Home", action = "Page"});
            //routes.MapRoute("SigninPatient", "signup/patient", new {controller = "Home", action = "Page"});
            //routes.MapRoute("SigninDoctor", "signin/doctor", new {controller = "Home", action = "Page"});
            //routes.MapRoute("ForgotPwd", "forgotpwd", new {controller = "Home", action = "Page"});
            //routes.MapRoute("Contact", "contact", new {controller = "Home", action = "Page"});
            //routes.MapRoute("PrivacyPolicy", "privacypolicy", new {controller = "Home", action = "Page"});
            //routes.MapRoute("TermOfService", "termofservice", new {controller = "Home", action = "Page"});
            //routes.MapRoute("SettingPassword", "settings/password", new {controller = "Home", action = "Page"});
            //routes.MapRoute("SettingNotification", "settings/notification", new {controller = "Home", action = "Page"});
            //routes.MapRoute("SettingBilling", "settings/billing", new {controller = "Home", action = "Page"});
            //routes.MapRoute("ProfileSearchDoctors", "profiles/search/doctors",
            //    new {controller = "Home", action = "Page"});
            //routes.MapRoute("PatientProfile", "patients/{acid}",
            //    new {controller = "Home", action = "Page", acid = UrlParameter.Optional});
            ...
            //    new {controller = "Home", action = "Page", acid = UrlParameter.Optional, apid = UrlParameter.Optional});
            ...
            //    new { controller = "Home", action = "Page", mrid = UrlParameter.Optional });
