intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="dbContextWrapper" type="Element">Document element to serve as the dbContextWrapper in which the HTML fragment will be created</param>
  ...
  'proxy': function() {
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular dbContextWrapper.</summary>
    ///   <param name="function" type="Function">The function whose dbContextWrapper will be changed.</param>
    ///   <param name="dbContextWrapper" type="PlainObject">The object to which the dbContextWrapper (this) of the function should be set.</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular dbContextWrapper.</summary>
    ///   <param name="dbContextWrapper" type="PlainObject">The object to which the dbContextWrapper of the function should be set.</param>
    ///   <param name="name" type="String">The name of the function whose dbContextWrapper will be changed (should be a property of the dbContextWrapper object).</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular dbContextWrapper.</summary>
...
intellisense.annotate(_object, {
  ...
  'fireWith': function() {
    /// <signature>
    ///   <summary>Call all callbacks in a list with the given dbContextWrapper and arguments.</summary>
    ///   <param name="dbContextWrapper" type="">A reference to the dbContextWrapper in which the callbacks in the list should be fired.</param>
...
intellisense.annotate(_object, {
  ...
  'notifyWith': function() {
    /// <signature>
    ///   <summary>Call the progressCallbacks on a Deferred object with the given dbContextWrapper and args.</summary>
    ///   <param name="dbContextWrapper" type="Object">Context passed to the progressCallbacks as the this object.</param>
    ///   <param name="args" type="Object">Optional arguments that are passed to the progressCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  ...
  'rejectWith': function() {
    /// <signature>
    ///   <summary>Reject a Deferred object and call any failCallbacks with the given dbContextWrapper and args.</summary>
    ///   <param name="dbContextWrapper" type="Object">Context passed to the failCallbacks as the this object.</param>
  ...
  'resolveWith': function() {
    /// <signature>
    ///   <summary>Resolve a Deferred object and call any doneCallbacks with the given dbContextWrapper and args.</summary>
    ///   <param name="dbContextWrapper" type="Object">Context passed to the doneCallbacks as the this object.</param>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    ...
    ///   <summary>Add elements to the set of matched elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of matched elements.</param>
    ///   <param name="dbContextWrapper" type="Element">The point in the document at which the selector should begin matching; similar to the dbContextWrapper argument of the $(selector, dbContextWrapper) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addBack': function() {
  ...
  'closest': function() {
    ...
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <param name="dbContextWrapper" type="Element">A DOM element within which a matching element may be found. If no dbContextWrapper is passed in then the dbContextWrapper of the jQuery set will be used instead.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
  ...
  'context': function() {
    /// <summary>The DOM node dbContextWrapper originally passed to jQuery(); if none was passed then dbContextWrapper will likely be the document.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
  ...
  'init': function() {
    ...
    ///   <param name="dbContextWrapper" type="">A DOM Element, Document, or jQuery to use as dbContextWrapper</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
