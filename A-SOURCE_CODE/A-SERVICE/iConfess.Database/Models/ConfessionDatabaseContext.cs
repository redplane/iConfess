...
namespace iConfess.Database.Models
{
    public class ConfessionDatabaseContext : DbContext
    {
        ...
        private void InitiateAccountTable(DbModelBuilder dbModelBuilder)
        {
            ...
            account.Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);

            // Relationships initialiation.
            // One account can create many categories.
            account.HasMany(x => x.CreatedCategories).WithOptional(x => x.Creator);
        ...
        private void InitiateCategoryTable(DbModelBuilder dbModelBuilder)
        {
            ...
            // Id is auto-generated by database.
            category.Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
        ...
        private void InitiateCommentTable(DbModelBuilder dbModelBuilder)
        {
            ...
            // Id is auto-generated by database.
            comment.Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
        }
        ...
        private void InitiateFollowCategoryTable(DbModelBuilder dbModelBuilder)
        {
            ...
            followCategory.HasRequired(x => x.Category).WithOptional(x => x.BeFollowed);
        }
        ...
        private void InitiateFollowPostTable(DbModelBuilder dbModelBuilder)
        {
            ...
            followPost.HasRequired(x => x.Post).WithOptional(x => x.BeFollowed);
        }
        ...
        private void InitiateNotificationComment(DbModelBuilder dbModelBuilder)
        {
            ...
            notificationComment.Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            
            // One notification belongs to a specific comment.
            notificationComment.HasRequired(x => x.Comment).WithOptional(x => x.Notification);

            // One notification belongs to a specific post.
            notificationComment.HasRequired(x => x.Post).WithOptional(x => x.NotificationComment);
        }
        ...
        /// </summary>
        /// <param name="dbModelBuilder"></param>
        private void InitiateNotificationPost(DbModelBuilder dbModelBuilder)
        {
            // Find notification comment configuration.
            ...
            // Id is auto-incremented by database.
            notificationPost.Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);

            // One notification belongs to a specific comment.
            notificationPost.HasRequired(x => x.Post).WithOptional(x => x.NotificationPost);
