...
namespace iConfess.Database.Models
{
    public class ConfessionDatabaseContext : DbContext
    {
        ...
        private void InitiatePostTable(DbModelBuilder dbModelBuilder)
        {
            ...
            // Id is auto-generated by database.
            post.Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            
            // One post can have many notifications about.
            post.HasMany(x => x.NotificationPosts).WithRequired(x => x.Post);
