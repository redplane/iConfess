...
var ClientCategoryService = (function () {
    ...
    ClientCategoryService.prototype.getCategories = function (conditions) {
    ...
    ClientCategoryService.prototype.deleteCategories = function (conditions) {
        // Request to api to obtain list of available categories in system.
        return this.clientApiService.delete(this.clientAuthenticationService.getTokenCode(), this.clientApiService.getBaseUrl() + "/" + this.urlDeleteCategory, null, conditions);
    };
